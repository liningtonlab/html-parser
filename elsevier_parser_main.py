...
def main():
    ...
    inp_file = Path("Files/html_files/123.html") # TODO: Test. Certain, string of path can be input
                                                                        # See soupling.inputs()
    ...
    headers = souping.soup_id_headers(soup)# TODO:
    rows = souping.soup_id_rows(soup)# TODO:
    comps = souping.soup_comp_id(soup)# TODO:
