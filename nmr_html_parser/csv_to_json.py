...
with open(csvFilePath, encoding="UTF-8") as csvFile:
  ...
  new_data = {'atom_index': ['2', '3', '4', '4a', '5', '6', '7', '8', '8a', '9', '10', '11', '', '12', '13', '14', '15', '2′',
                  '3′', '4′', '4a′', '5′', '6′', '7′', '8′', '8a′', '9′', '10′', '11′', '', '12′', '13′', '14′', '15′',
                  'OCH3-5'],
   ...
   '2_hspec': ['', '5.67', '7.24', '', '', '', '', '', '', '7.52', '6.87', '4.71', '4.73', '5.6', '', '1.69', '1.75',
               '', '6.2', '8.12', '', '', '', '', '7.2', '', '7.6', '6.95', '4.57', '4.54', '4.79', '', '1.35', '1.71',
               '4.05'],
   '2_multi': ['', 'd', 'd', '', '', '', '', '', '', 'd', 'd', 'dd', 'dd', 't', '', 's', 's', '', 'd', 'd', '', '', '',
               '', 'brs', '', 'd', 'dd', 'dd', 'dd', 'dd', '', 's', 's', 's'],
   '2_coupling': ['', '9.9', '9.9', '', '', '', '', '', '', '2.1', '2.1', '11.3, 7.0', '11.3, 7.0', '7.0', '', '', '',
                  '', '9.8', '9.8', '', '', '', '', '', '', '2.4', '2.4, 0.9', '10.2, 6.4', '10.2, 5.4', '6.4, 5.4', '',
                  '', '', '']}
